      ...
      <Dialog as="div" className="relative z-50" onClose={onOpenChange}>
        ...
        >
          <div className={cn('fixed inset-0 flex w-screen items-center justify-center p-4')}>
            <DialogPanel
              className={cn(
                'min-h-[750px] overflow-hidden rounded-xl rounded-b-lg bg-background pb-6 shadow-2xl backdrop-blur-2xl animate-in sm:rounded-2xl md:min-h-[550px] md:w-[900px] lg:w-[1000px]',
              )}
            >
              <DialogTitle
              ...
              <div className="max-h-[700px] overflow-auto px-6 md:max-h-[550px] md:min-h-[550px] md:w-[900px] lg:w-[1000px]">
                <Tabs.Root
                  value={activeTab}
